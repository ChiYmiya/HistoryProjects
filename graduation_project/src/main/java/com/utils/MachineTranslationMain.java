...
public class MachineTranslationMain {
    ...
    // 控制台获取以下信息
    private static String APPID = "8f2201fe";
    private static String APISecret = "ZjU0OWYzM2E1ZTc5NWMyNWI5YmI1YTZh";
    private static String APIKey = "24a8c06979e610b54748f926462df4e7";
...
//    }
    public static String fanyi() {
        ...
        try {
            ...
            Gson gson = new Gson();
            Map<String, Object> jsonObject1 = gson.fromJson(String.valueOf(jsonObject), Map.class);

            Map<String, Object> transResult = (Map<String, Object>) jsonObject1.get("trans_result");
            dst = (String) transResult.get("dst");
            String src = (String) transResult.get("src");
            String from = (String) jsonObject.get("from");
            String to = (String) jsonObject.get("to");

            System.out.println("Translated text: " + dst);
            System.out.println("Original text: " + src);
            return dst;
        } catch (Exception e) {
            e.printStackTrace();
        }
