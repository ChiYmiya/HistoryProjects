...
public class WangzhangonggaoController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,WangzhangonggaoEntity wangzhangonggao, 
		HttpServletRequest request){
        EntityWrapper<WangzhangonggaoEntity> ew = new EntityWrapper<WangzhangonggaoEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        ...
        wangzhangonggao = wangzhangonggaoService.selectView(new EntityWrapper<WangzhangonggaoEntity>().eq("id", id));
