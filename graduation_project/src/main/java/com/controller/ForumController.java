...
import com.utils.MachineTranslationMain;
...
public class ForumController {
    ...
    public R translate(@RequestBody String textContent) {
        System.out.println("textContent = " + textContent);
        MachineTranslationMain trans = new MachineTranslationMain();
        trans.setTEXT(textContent);
        String res = trans.fanyi();
//        return R.ok(Map<tst,textContent>);
