...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="游戏分类" prop="youxifenlei">
            <el-select v-model="ruleForm.youxifenlei" placeholder="请选择游戏分类" :disabled=" false  ||ro.youxifenlei" multiple filterable>
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="个人简介" prop="gerenjianjie">
            <editor 
