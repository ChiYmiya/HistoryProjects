...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    <el-form
      ...
      label-width="150px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="游戏编号" prop="youxibianhao">
              <el-input v-model="ruleForm.youxibianhao" placeholder="游戏编号" disabled></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="游戏名称" prop="youximingcheng">
            <el-input v-model="ruleForm.youximingcheng" 
                placeholder="游戏名称" clearable :disabled=" false  ||ro.youximingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="游戏分类" prop="youxifenlei">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="评分" prop="pingfen">
			<el-input-number v-model="ruleForm.pingfen" placeholder="评分" :disabled="ro.pingfen"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="平台" prop="pingtai">
            <el-input v-model="ruleForm.pingtai" 
                placeholder="平台" clearable :disabled=" false  ||ro.pingtai"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="游戏介绍" prop="youxijieshao">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/youxibiaoqian/biaoqian', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
