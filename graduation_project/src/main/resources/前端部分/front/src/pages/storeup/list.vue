<template>
  ...
  >
    ...
    <el-form :inline="true" :model="formSearch" class="formSearch">
      ...
      <el-form-item>
        <el-button type="primary" @click="getStoreupList(1)" class="chaxun"
          >查询</el-button
        >
      </el-form-item>
    </el-form>
    <el-row :gutter="20">
      ...
      >
        <el-card :body-style="{ padding: '0px', cursor: 'pointer' }">
          ...
          ></el-image>
          <el-image
            v-else-if="item.picture && item.picture.substr(0, 4) != 'http'"
...
export default {
  ...
  methods: {
    ...
    getStoreupList(page) {
      ...
      this.$http
        .get("storeup/list", { params: Object.assign(params, searchWhere) })
        .then((res) => {
          if (res.data.code == 0) {
