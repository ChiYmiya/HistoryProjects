		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"0px 0px 0","margin":"0px","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","fontSize":"inherit"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","margin":"0 0 10px","borderRadius":"0 0 8px 8px","textAlign":"left","background":"#fff","display":"block","width":"100%","fontSize":"inherit","order":"1"}' >
					...
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}' class="select" label="游戏分类" prop="youxifenlei">
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">游戏分类</label>
						<el-select clearable v-model="searchForm.youxifenlei" placeholder="请选择游戏分类" multiple>
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.youxifenlei&&this.searchForm.youxifenlei.length){
			  let youxifenleiArr = []
			  for(let i in this.searchForm.youxifenlei){
				  youxifenleiArr.push('%' + this.searchForm.youxifenlei[i] + '%')
			  }
            params['youxifenlei'] = youxifenleiArr.join(',')
          }
