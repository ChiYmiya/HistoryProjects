	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="投诉日期" prop="tousuriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.tousuriqi" label="投诉日期" prop="tousuriqi">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="投诉原因" prop="tousuyuanyin">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.tousuyuanyin" label="投诉原因" prop="tousuyuanyin">
                    <span :style='{"padding":"0 20px","color":"inherit","background":"none","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.tousuyuanyin"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.zhuangtaiOptions = "已处理,未处理".split(',')
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tousuyuanyin = this.ruleForm.tousuyuanyin.replace(reg,'../../../gamemsgbs/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
